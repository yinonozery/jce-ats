...
const Home: React.FC = () => {
    ...
    return (
        <div>
            ...
            Proin pulvinar nibh luctus, viverra massa eget, tempus mi. Fusce eu purus ornare sem aliquet congue sit amet et ante.Aliquam interdum eleifend nibh nec ultrices. Sed eu venenatis eros. Maecenas vestibulum a neque in ullamcorper.<br />
            Etiam a tempus tortor, sit amet rutrum nisl. Pellentesque lacus diam, malesuada eu dolor non, maximus congue justo. Aliquam ultricies a urna vitae tincidunt.
            <p style={{ textAlign: 'center' }}><img style={{ width: '100%' }} src="https://i.ibb.co/vztv2pg/se.png" alt="" /></p>
